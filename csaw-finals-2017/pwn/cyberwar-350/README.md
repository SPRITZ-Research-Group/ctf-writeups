...
This is the second part of [DEFCON 1](../../rev/defcon). Read that one first. The same system image is used here. We want to dump the flag at 0x1664 on the remote server.
